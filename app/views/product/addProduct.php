    ...
    <main id="body">
        <div class="container my-5 py-5">
            <form id="product_form" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST"
                ...
                <div class="row">
                    <label class="col s2 label-fix" for="name">Name</label>
                    <div class="col s4">
                        <input class="form-control" type="text" name="name" id="name"
                            placeholder="Insert any alphanumeric characters" required>
                    </div>
                </div>

                <div class="row">
                    <label class="col s2 label-fix" for="price">Price ($)</label>
                    <div class="col s4">
